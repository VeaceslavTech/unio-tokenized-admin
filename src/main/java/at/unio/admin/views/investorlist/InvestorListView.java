package at.unio.admin.views.investorlist;
...
@Route(value = "investor-list", layout = MainLayout.class)
@RolesAllowed("ADMIN")
@Uses(Icon.class)
public class InvestorListView extends Div {
    ...
    public InvestorListView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("investor-list-view");
